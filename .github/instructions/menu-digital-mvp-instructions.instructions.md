---
description: "Use when building or changing the multi-restaurant digital menu, including mobile-first UI, restaurant-specific configuration, opening hours, and WhatsApp orders."
applyTo:
	 "**/*.html",
	 "**/*.css",
	"**/*.js",
